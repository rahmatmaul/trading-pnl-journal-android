<p align="center">
  <img src="docs/banner.svg" alt="Trading Journal V4.0.1 Offline for Android" width="100%" />
</p>
...
<p align="center">
  ...
  <img alt="Version 4.0.1" src="https://img.shields.io/badge/version-4.0.1-087BFF">
...
<p align="center">
  <a href="https://github.com/rahmatmaul/trading-pnl-journal-android/raw/main/release/TradingJournal-v4.0.1.apk"><strong>Download APK V4.0.1 Offline</strong></a>
  ·
...
## Trading Journal V4.0.1 Offline

<p align="center"><img src="docs/app-icon-v25-master.png" alt="Trading PnL Journal folded journal icon" width="128" /></p>

V4.0.1 kembali fokus menjadi aplikasi Android **100% offline** tanpa login,
Google Drive, cloud sync, atau aplikasi Windows. Seluruh jurnal dan pengaturan
tetap berada di perangkat serta folder backup yang dipilih sendiri.

Fondasi UI V3.1 memoles jurnal menjadi **Trading Performance OS** yang terasa lebih hidup tetapi tetap ringan.
...
1. Download [`TradingJournal-v4.0.1.apk`](https://github.com/rahmatmaul/trading-pnl-journal-android/raw/main/release/TradingJournal-v4.0.1.apk).
...
| Versi | Fokus update |
| --- | --- |
| **V4.0.1** | Kembali Android offline-only; login, Drive sync, dan distribusi Windows dihapus |
...
Suite JVM/Robolectric mencakup 16 test untuk CRUD, duplicate, reopen persistence,
...
serta migrasi V1→V2 dan pembersihan state cloud V3→V4 tanpa kehilangan jurnal.
